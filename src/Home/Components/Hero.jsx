    ...
    <section className="bg-zinc-950 text-white py-16">
      <div className="w-11/12 lg:w-9/11 mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex-1 space-y-6 text-center md:text-left">
          ...
          <button
            className="inline-flex items-center gap-2 px-7 py-3 rounded-full bg-[#E7FF00] text-zinc-950 font-semibold shadow-[0_4px_24px_rgba(231,255,0,0.4)] backdrop-blur-md hover:scale-105 hover:shadow-[0_6px_32px_rgba(231,255,0,0.6)] transition-all duration-300 ease-in-out cursor-pointer"
